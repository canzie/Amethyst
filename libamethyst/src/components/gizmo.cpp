...
static constexpr uint32_t COL_X = packColor(0xED, 0x48, 0x5B, 255);        // #ED485B
static constexpr uint32_t COL_Y = packColor(0x86, 0xC9, 0x3F, 255);        // #86C93F
static constexpr uint32_t COL_Z = packColor(0x41, 0x8B, 0xEF, 255);        // #418BEF
static constexpr uint32_t COL_X_HOVER = packColor(0xFF, 0x6B, 0x7A, 255);  // Lighter red
static constexpr uint32_t COL_Y_HOVER = packColor(0xA8, 0xE0, 0x5F, 255);  // Lighter green
static constexpr uint32_t COL_Z_HOVER = packColor(0x6B, 0xA8, 0xFF, 255);  // Lighter blue
static constexpr uint32_t COL_ACTIVE = packColor(255, 220, 64, 255);       // rgb(255, 220, 64)
static constexpr uint32_t COL_PLANE_XY = packColor(0x41, 0x8B, 0xEF, 100); // Blue (Z normal)
static constexpr uint32_t COL_PLANE_XZ = packColor(0x86, 0xC9, 0x3F, 100); // Green (Y normal)
static constexpr uint32_t COL_PLANE_YZ = packColor(0xED, 0x48, 0x5B, 100); // Red (X normal)
static constexpr uint32_t COL_WHITE = packColor(255, 255, 255, 200);
static constexpr uint32_t COL_LABEL_BG = packColor(30, 30, 30, 220);
